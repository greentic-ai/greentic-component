# PR-00-VISION (greentic-component): Add v0.6 vision docs + Codex rules + deprecation policy
...
## Repo purpose (v0.6)
Core component contract glue: describe(), schemas, lifecycle modes, QA hooks; no domain knowledge.
...
## Repo-specific notes (greentic-component)
Flag as legacy:
- Any old lifecycle entrypoints that bypass QA-driven lifecycle modes
- Any docs that imply per-domain component logic in core
Canonical must emphasize:
- describe() / schemas / QA hooks / CBOR-first IO expectations
- No provider/business logic in core component crate
